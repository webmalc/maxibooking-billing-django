# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2017-09-27 12:17
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('finances', '0024_remove_order_disable_date'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='price',
            name='price',
            field=djmoney.models.fields.MoneyField(db_index=True, decimal_places=2, default=Decimal('0.0'), default_currency='USD', max_digits=20, verbose_name='price'),
        ),
    ]

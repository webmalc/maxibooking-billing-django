# Generated by Django 2.1.7 on 2019-08-14 08:00
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('hotels', '0027_auto_20190226_1109'),
    ]
    ...
    operations = [
        migrations.AddField(
            model_name='room',
            name='max_occupancy',
            field=models.PositiveIntegerField(db_index=True, default=1, help_text='max guest occupancy', validators=[django.core.validators.MinValueValidator(1)], verbose_name='max occupancy'),
        ),
        migrations.AddField(
            model_name='room',
            name='price',
            field=djmoney.models.fields.MoneyField(db_index=True, decimal_places=2, default=Decimal('0'), max_digits=20, validators=[djmoney.models.validators.MinMoneyValidator(0)], verbose_name='price'),
        ),
        migrations.AddField(
            model_name='room',
            name='price_currency',
